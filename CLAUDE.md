...
6. **打包**：`cp NOTICE-n8n-localization.md packages/frontend/editor-ui/dist/ && tar -czf "n8n-editor-ui@<ver>.tar.gz" -C packages/frontend/editor-ui dist`（SUL 随附条款随包分发，评审 D-E5-1/D-E5-8；macOS tar 的 LIBARCHIVE.xattr 警告在 Linux 解包无害）
