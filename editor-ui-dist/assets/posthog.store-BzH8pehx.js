...
import { Pa as EXPERIMENTS_TO_TRACK, zi as LOCAL_STORAGE_EXPERIMENT_OVERRIDES } from "./constants-CfolRcla.js";
...
var usePostHog = defineStore("posthog", () => {
	...
	*/
	...
	const init = (evaluatedFeatureFlags, evaluatedFeatureFlagPayloads) => {
		...
		if (window.posthog.__loaded) identifyUserAndInstance();
		else window.posthog.init(config.apiKey, {
			...options,
