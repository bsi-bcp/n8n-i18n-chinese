...
import { t as require_lib } from "./lib-DCPrRYqD.js";
import { c as useRoute, l as useRouter } from "./vue-router-BayijiqM.js";
import { E as deriveHomeProject, Ft as useAIAssistantHelpers, H as useNodeTypesStore, Mi as isDebouncedFunction, Mt as getBuilderCredits, O as injectWorkflowDocumentStore, Ot as chatWithBuilder, Pt as truncateBuilderMessages, T as createWorkflowDocumentId, en as useWorkflowHelpers, fn as useNDVStore, j as useWorkflowDocumentStore, jt as getAiSessions, kt as clearBuilderSession, nn as useWorkflowId, t as useWorkflowsStore, tn as useRouteWorkflowId, xn as useSourceControlStore, y as useWorkflowExecutionStateStore } from "./workflows.store-CyNGMYqF.js";
import { Zn as ResponseError, a as getWorkflowVersion, gn as getFirstAdoptionDate, i as getWorkflowHistory, o as getWorkflowVersionsByIds, r as getPublishTimeline, s as updateWorkflowHistoryVersion, sr as STORES, t as useRootStore, ur as defineStore, xt as updateNpsSurveyState } from "./useRootStore-zV3ddzsk.js";
import { Lt as getResourcePermissions, Qn as validateNodeSelectionForGrouping, _a as isExpression, ya as dedupe } from "./src-BvYowTlb.js";
...
import { Ai as LOCAL_STORAGE_BROWSER_NOTIFICATION_METADATA, Qa as MERGE_ASK_BUILD_EXPERIMENT, Ra as FOCUSED_NODES_EXPERIMENT, ci as MODAL_CLOSE, di as NPS_SURVEY_MODAL_KEY, ha as EditorEnabledFeaturesKey, ka as CODE_WORKFLOW_BUILDER_EXPERIMENT, li as MODAL_CONFIRM, si as MODAL_CANCEL, t as AutoSaveState } from "./constants-CfolRcla.js";
import { c as THREE_DAYS_IN_MILLIS, o as SEVEN_DAYS_IN_MILLIS, s as SIX_MONTHS_IN_MILLIS, t as DEBOUNCE_TIME } from "./durations-B_eUP1zI.js";
import { a as BUILDER_ENABLED_VIEWS, r as useChatPanelStateStore, t as useCodeDiff } from "./useCodeDiff-zZmfEHwe.js";
import { t as getDebounceTime } from "./useDebounce-C57cDTa1.js";
import { t as usePostHog } from "./posthog.store-BzH8pehx.js";
import { _ as tryToParseNumber, h as stringSizeInBytes } from "./typesUtils-MNq3j-_F.js";
import { a as getNewWorkflow, t as useWorkflowsListStore } from "./workflowsList.store-btNOTGAu.js";
