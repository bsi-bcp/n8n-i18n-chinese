import { $n as getFullApiResponse, er as makeRestApiRequest } from "./useRootStore-zV3ddzsk.js";
...
var duplicateAgent = async (context, projectId, agentId, name) => {
	const [agent, configResponse] = await Promise.all([getAgent(context, projectId, agentId), getAgentConfig(context, projectId, agentId)]);
...
var updateAgentConfig = async (context, projectId, agentId, config, baseConfigHash) => {
	return await makeRestApiRequest(context, "PUT", `/projects/${projectId}/agents/v2/${agentId}/config`, {
		config,
		baseConfigHash
	});
};
...
var updateAgentSkill = async (context, projectId, agentId, skillId, updates, baseSkillHash) => {
	return await makeRestApiRequest(context, "PATCH", `/projects/${projectId}/agents/v2/${agentId}/skills/${skillId}`, {
		...updates,
		baseSkillHash
	});
};
var getAgentBackgroundJobs = async (context, projectId, agentId, threadId) => {
	return await makeRestApiRequest(context, "GET", `/projects/${encodeURIComponent(projectId)}/agents/v2/${encodeURIComponent(agentId)}/chat/${encodeURIComponent(threadId)}/background-tasks`);
};
...
//#endregion
export { revertAgentToPublished as A, listAgentFiles as C, listAgentsPage as D, listAgents as E, updateAgentConfig as F, updateAgentSkill as I, updateAgentTask as L, runAgentTask as M, testAgentVectorStore as N, listAgentsPageGlobal as O, unpublishAgent as P, uploadAgentFiles as R, getTestChatMessages as S, listAgentVersions as T, getAgentTasks as _, createAgentSkill as a, getModelCatalog as b, deleteAgentFile as c, duplicateAgent as d, getAgent as f, getAgentConfigValidation as g, getAgentConfig as h, createAgent as i, revertAgentToVersion as j, publishAgent as k, deleteAgentTask as l, getAgentCapabilitySummary as m, clearTestChatMessages as n, createAgentTask as o, getAgentBackgroundJobs as p, connectIntegration as r, deleteAgent as s, cancelAgentChatRun as t, disconnectIntegration as u, getChatMessages as v, listAgentIntegrations as w, getProviderModels as x, getIntegrationStatus as y, warmAgentKnowledgeSandbox as z };
