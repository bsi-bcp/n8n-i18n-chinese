...
import { n as RadioGroupItem_default, t as RadioGroup_default } from "./RadioGroup-D0sBouUU.js";
...
import { Oi as displayParameter, Qt as INSTANCE_AI_CATALOG_PROVIDERS, un as deriveInstanceAiSetupState } from "./src-BvYowTlb.js";
import { t as useTelemetry } from "./useTelemetry-D-DsTw_T.js";
import { l as TIME } from "./durations-B_eUP1zI.js";
import { a as TELEMETRY_EVENT, r as scrubSecretsInText } from "./src-7WmJaBUb.js";
import { C as SANDBOX_PROVIDER_LABELS } from "./constants-7S3vaTkQ.js";
import { n as deriveInstanceAiConfiguration, t as useInstanceAiSettingsStore } from "./instanceAiSettings.store-TqnmUR2u.js";
...
//#endregion
//#region ../../@n8n/utils/src/redaction/sanitize-error-detail.ts
var QUOTED_URL_QUERY = /(["'])(https?:\/\/(?:(?!\1)[^\s?<>])+)(?:\?(?:\\.|(?!\1(?!\w))[^\s<>\\])*)?/gi;
var BARE_URL_QUERY = /(https?:\/\/[^\s?<>]+)(?:\?[^\s<>]*)?/gi;
function sanitizeErrorDetail(message, maxLength) {
	return scrubSecretsInText(message).replace(QUOTED_URL_QUERY, "$1$2").replace(BARE_URL_QUERY, "$1").slice(0, maxLength);
}
//#endregion
...
var InstanceAiOnboardingWizard_vue_vue_type_style_index_0_lang_module_default = {
	body: "_body_d4h69_1",
	description: "_description_d4h69_11",
	fields: "_fields_d4h69_16",
	compactLabel: "_compactLabel_d4h69_23",
	fieldHint: "_fieldHint_d4h69_27",
	joinedCards: "_joinedCards_d4h69_31",
	optionCard: "_optionCard_d4h69_48",
	optionControl: "_optionControl_d4h69_87",
	optionCopy: "_optionCopy_d4h69_91",
	optionTitle: "_optionTitle_d4h69_99",
	optionBadge: "_optionBadge_d4h69_105",
	optionDescription: "_optionDescription_d4h69_110",
	done: "_done_d4h69_114",
	successIcon: "_successIcon_d4h69_121",
	inlineDoneAction: "_inlineDoneAction_d4h69_125",
	summary: "_summary_d4h69_129",
	summaryRow: "_summaryRow_d4h69_137",
	summaryCopy: "_summaryCopy_d4h69_161",
	mono: "_mono_d4h69_168",
	footer: "_footer_d4h69_172",
	editFooter: "_editFooter_d4h69_188",
	failureDetail: "_failureDetail_d4h69_196",
	dots: "_dots_d4h69_201",
	dot: "_dot_d4h69_201",
	activeDot: "_activeDot_d4h69_217"
};
