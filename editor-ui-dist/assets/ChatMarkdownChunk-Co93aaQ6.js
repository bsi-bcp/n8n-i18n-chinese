const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/es-Dabt7oqX.js","assets/chunk-CC9Q-vWm.js","assets/core-DJ1sokmq.js","assets/languageModules-C2Sd7Tpb.js","assets/xml-Dhz3r8WZ.js","assets/json-YUbUxZ2p.js"])))=>i.map(i=>d[i]);
	...
	async function loadLanguageModules() {
		...
		try {
			const promise = Promise.all([__vitePreload(async () => {
				const { default: highlight } = await import("./es-Dabt7oqX.js");
				return { default: highlight };
			}, __vite__mapDeps([0,1,2])).then(({ default: highlight }) => highlight), __vitePreload(() => import("./languageModules-C2Sd7Tpb.js"), __vite__mapDeps([3,4,5]))]);
			asyncImport = {
				status: "inProgress",
				promise
			};
...
var ChatButtons_vue_vue_type_style_index_0_lang_module_default = { buttons: "_buttons_f5szf_1" };
...
var ChatMarkdownChunk_vue_vue_type_style_index_1_lang_module_default = {
	container: "_container_fy8ww_1",
	command: "_command_fy8ww_9"
};
