...
import { D as disposeWorkflowDocumentStore, E as deriveHomeProject, Et as useCredentialsStore, H as useNodeTypesStore, Mr as injectStrict, T as createWorkflowDocumentId, bn as useProjectsStore, fn as useNDVStore, ht as getSampleWorkflowByTemplateId, j as useWorkflowDocumentStore, ln as disposeNDVStore, mn as useEnvironmentsStore, nn as useWorkflowId, t as useWorkflowsStore, y as useWorkflowExecutionStateStore } from "./workflows.store-CyNGMYqF.js";
import { t as useRootStore } from "./useRootStore-zV3ddzsk.js";
import { Nn as WorkflowStructureValidationError, Pn as safeParseWorkflowStructure } from "./src-BvYowTlb.js";
...
import { Sa as WorkflowDocumentStoreKey, fo as EnterpriseEditionFeature } from "./constants-CfolRcla.js";
import { o as getNewWorkflowData, t as useWorkflowsListStore } from "./workflowsList.store-btNOTGAu.js";
import { n as useUIStore } from "./ui.store-DF3DguxG.js";
import { n as useDocumentTitle } from "./useDocumentTitle-BvpyR-io.js";
import { n as useHistoryStore } from "./useNodeHelpers-D1AK6w9s.js";
...
import { t as useExecutionDebugging } from "./useExecutionDebugging-uFofj41k.js";
	...
	*/
	async function handleTemplateImportRoute() {
		...
		if (currentWorkflowId) {
			const workflowDocumentStore = useWorkflowDocumentStore(createWorkflowDocumentId(currentWorkflowId));
