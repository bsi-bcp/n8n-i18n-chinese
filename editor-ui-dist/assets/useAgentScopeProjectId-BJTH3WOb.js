...
import { Et as useCredentialsStore, O as injectWorkflowDocumentStore, bn as useProjectsStore } from "./workflows.store-CyNGMYqF.js";
...
import { D as listAgentsPage, f as getAgent } from "./useAgentApi-B-eyP3L8.js";
...
function useQuickConnect() {
	...
	async function connectToPinecone(quickConnectOption) {
		const { ConnectPopup } = await __vitePreload(async () => {
			const { ConnectPopup } = await import("./dist-GcWsy_mV.js");
			return { ConnectPopup };
		}, []);
