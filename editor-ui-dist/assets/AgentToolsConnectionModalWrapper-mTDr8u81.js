...
import { Ct as useAiGatewayStore, H as useNodeTypesStore, K as filterAndSearchNodes, St as stripToolSuffix, bn as useProjectsStore, nt as isNodePreviewKey, ot as removePreviewToken, t as useWorkflowsStore, tt as isAiGatewayEligibleNode, xn as useSourceControlStore } from "./workflows.store-CyNGMYqF.js";
import { t as useRootStore } from "./useRootStore-zV3ddzsk.js";
import { $i as resolveSupportedCredentialActivation, G as INCOMPATIBLE_WORKFLOW_TOOL_BODY_NODE_TYPES, Lt as getResourcePermissions, Sa as isCommunityPackageName, lo as v4, pa as NodeConnectionTypes } from "./src-BvYowTlb.js";
...
import { Ar as AGENT_TOOL_CONFIG_MODAL_KEY, n as DEFAULT_NEW_WORKFLOW_NAME } from "./constants-CfolRcla.js";
import { a as TELEMETRY_EVENT } from "./src-7WmJaBUb.js";
import { s as getWorkflow } from "./workflowsList.store-btNOTGAu.js";
...
import { n as SAMPLE_SUBWORKFLOW_TRIGGER_ID, r as SAMPLE_SUBWORKFLOW_WORKFLOW } from "./samples-Bhi5I_-V.js";
import { a as workflowToolTriggerLabel, c as toolRefToNode, d as workflowToNewToolRef, i as nodeTypeToNewMcpServer, n as mcpServerToNode, o as getExistingToolNames, s as nodeTypeToNewToolRef, t as isMcpRelatedNodeType } from "./useMcpServerAdapter-CDdYAFqJ.js";
import { n as toolCategoryForNodeType, r as useAgentToolCatalog, t as hasInputs } from "./useAgentToolCatalog-Coh4mJNU.js";
import { a as TOOL_CONNECTION_CREDITS_LABEL_KEY, o as hasToolConnection } from "./ToolIcon-CnvIUCSR.js";
import { t as ToolsConnectionModal_default } from "./ToolsConnectionModal-BUVZEBKi.js";
import { t as McpRegistrySuggestionFooter_default } from "./McpRegistrySuggestionFooter-BcLHWoSG.js";
...
var AgentToolsConnectionModalWrapper_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		*/
		...
		onMounted(() => {
			if (isWorkflow.value) loadWorkflows(props.data.projectId);
		...
		*/
		...
		const items = computed(() => {
			if (isWorkflow.value) return [...availableWorkflows.value.map(availableWorkflowItem), ...incompatibleWorkflows.value.map(({ workflow, reason }) => disabledWorkflowItem(workflow, reason))];
			const out = [];
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(ToolsConnectionModal_default, {
				...
				title: isWorkflow.value ? unref(i18n).baseText("generic.workflows") : void 0,
				searchPlaceholder: isWorkflow.value ? unref(i18n).baseText("agents.tools.workflow.search.placeholder") : void 0,
				size: "2xlarge",
				"detail-item": null,
				allowWorkflowCreation: isWorkflow.value && canCreateWorkflow.value,
				workflowCreationLoading: isCreatingWorkflow.value,
