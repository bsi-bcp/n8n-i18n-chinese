...
import { D as NodeCredentials_default, f as collectParametersByTab, m as createCommonNodeSettings, t as ParameterInputList_default, x as setParameterValue } from "./ParameterInputList-o9BqeVh0.js";
import { D as disposeWorkflowDocumentStore, Et as useCredentialsStore, H as useNodeTypesStore, T as createWorkflowDocumentId, bn as useProjectsStore, fn as useNDVStore, j as useWorkflowDocumentStore, ln as disposeNDVStore, mn as useEnvironmentsStore } from "./workflows.store-CyNGMYqF.js";
import { t as N8nTabs_default } from "./N8nTabs-V6GkHG3I.js";
import { Fi as getNodeParametersIssues, Pi as getNodeParameters, Vi as isDefaultNodeName, ba as deepCopy, ca as isINodePropertyOptions, qi as makeNodeName } from "./src-BvYowTlb.js";
import { t as useSettingsStore } from "./settings.store-DuH97XDt.js";
import { Sa as WorkflowDocumentStoreKey, ga as ExpressionLocalResolveContextSymbol, ma as ChatHubToolContextKey, xa as ToolConfigCredentialSelectedKey } from "./constants-CfolRcla.js";
...
*/
function omitOperationOptions(description, optionValues) {
	const copy = deepCopy(description);
	for (const property of copy.properties) {
		if (property.name !== "resource" && property.name !== "operation" || !Array.isArray(property.options)) continue;
		property.options = property.options.filter((option) => !isINodePropertyOptions(option) || typeof option.value !== "string" || !optionValues.includes(option.value));
...
var NodeToolSettingsContent_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_1qjwu_1",
	tabs: "_tabs_1qjwu_9",
	tabContent: "_tabContent_1qjwu_15",
	noParameters: "_noParameters_1qjwu_22",
	commonSettings: "_commonSettings_1qjwu_26"
};
