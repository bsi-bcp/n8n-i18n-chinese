...
import { p as useDocumentVisibility, x as useLocalStorage } from "./dist-CaaDNBsJ.js";
...
import { i as DialogDescription_default, r as DialogHeader_default, t as DialogTitle_default } from "./DialogTitle-CeYK196n.js";
...
import { a as useWorkflowSaveStore, c as useWorkflowHistoryStore, r as useWorkflowSaving } from "./builder.store-BFFJZOmb.js";
...
import { n as AVATAR_SIZES, t as N8nAvatar_default } from "./N8nAvatar--rumNPMu.js";
...
import { H as useNodeTypesStore, O as injectWorkflowDocumentStore, Sn as ProjectTypes, T as createWorkflowDocumentId, Wn as getActivatableTriggerNodes, bn as useProjectsStore, dn as injectNDVStoreIfProvided, hn as ResourceType, in as useTagsStore, j as useWorkflowDocumentStore, nn as useWorkflowId, t as useWorkflowsStore, xn as useSourceControlStore } from "./workflows.store-CyNGMYqF.js";
...
import { t as N8nUserInfo_default } from "./N8nUserInfo-LyrXP-A-.js";
import { t as N8nUserSelect_default } from "./N8nUserSelect-CTXFGpTY.js";
import { t as Dialog_default } from "./Dialog-C7QOjdFe.js";
import { t as DialogFooter_default } from "./DialogFooter-C-aSBlo_.js";
import { Zn as ResponseError, t as useRootStore, ur as defineStore } from "./useRootStore-zV3ddzsk.js";
import { Lt as getResourcePermissions, wa as jsonParse } from "./src-BvYowTlb.js";
...
import { D as TIME_SAVED_DOCS_URL, Di as WORKFLOW_SHARE_MODAL_KEY, Ei as WORKFLOW_SETTINGS_MODAL_KEY, Hr as MAIN_HEADER_TABS, Qr as DUPLICATE_MODAL_KEY, Sa as WorkflowDocumentStoreKey, Si as WORKFLOW_HISTORY_NAME_VERSION_MODAL_KEY, Ti as WORKFLOW_PUBLISH_MODAL_KEY, Ur as WORKFLOW_HISTORY_PUBLISH_TIMELINE_TAB, _ as ERROR_WORKFLOW_DOCS_URL, _i as WORKFLOW_ACTIVE_MODAL_KEY, aa as LOCAL_STORAGE_WORKFLOW_REVIEW_SUBMITTED_DIALOG_HIDDEN, fo as EnterpriseEditionFeature, ii as IMPORT_WORKFLOW_URL_MODAL_KEY, na as LOCAL_STORAGE_WORKFLOW_REVIEW_PUBLISH_CHOICE_HIDDEN, ra as LOCAL_STORAGE_WORKFLOW_REVIEW_REQUIRED_BY_WORKFLOW, t as AutoSaveState, v as EVALUATIONS_DOCS_URL, vi as WORKFLOW_DESCRIPTION_MODAL_KEY, vo as WORKFLOW_MENU_ACTIONS, wi as WORKFLOW_HISTORY_VERSION_UNPUBLISH } from "./constants-CfolRcla.js";
...
import { t as useEvaluationStore } from "./evaluation.store-BQJfd372.js";
...
import { t as useDocumentVisibility$1 } from "./useDocumentVisibility-C9Rq_ZxE.js";
...
import { n as CharacterCount_default, r as useMoveResourceToProjectToast, t as WorkflowVersionForm_default } from "./WorkflowVersionForm-h2TP7LP3.js";
import { n as telemetry } from "./telemetry-ytMVmq0K.js";
import { t as useDependencies } from "./useDependencies-BKsniwXh.js";
import { i as getLastPublishedVersion, o as getVersionLabel, r as generateVersionLabelFromId } from "./utils-CX8vFX4E.js";
import { t as router } from "./router-BlZM0QaX.js";
...
import { l as MCP_SETTINGS_VIEW, o as MCP_DOCS_PAGE_URL } from "./mcp.constants-COls6BjY.js";
import { t as useWorkflowReviewsFeature } from "./useWorkflowReviewsFeature-CZCX81D2.js";
import { r as WORKFLOW_REVIEW_REQUESTS_VIEW, t as REVIEW_INBOX_QUERY_PARAM } from "./constants-C_Ploj9f.js";
import { t as usePushConnection } from "./usePushConnection-6CEPWKaN.js";
import { t as FolderBreadcrumbs_default } from "./FolderBreadcrumbs-CxVDkPbG.js";
import { t as ConnectionTracker_default } from "./ConnectionTracker-cd0nCEfK.js";
import { t as useWorkflowEvaluationState } from "./useWorkflowEvaluationState-BTzJKCIH.js";
...
import { a as createWorkflowReviewRequest, f as fetchWorkflowReviewRequests, n as formatUserDisplayName, p as updateWorkflowReviewRequestVersion, s as fetchEligibleReviewers } from "./workflowReviews.utils-Crc1dFP2.js";
import { t as useLatestFetch } from "./useLatestFetch-BJwSI9AN.js";
import "./usePushConnection-CGcoRtbL.js";
...
var SuggestedActions_vue_vue_type_style_index_0_lang_module_default = {
	triggerContainer: "_triggerContainer_3x4e9_1",
	hiddenTrigger: "_hiddenTrigger_3x4e9_7",
	activeTrigger: "_activeTrigger_3x4e9_13",
	popoverContent: "_popoverContent_3x4e9_18",
	header: "_header_3x4e9_25",
	actionItem: "_actionItem_3x4e9_32",
	actionable: "_actionable_3x4e9_40",
...
var UserStack_vue_vue_type_style_index_0_lang_module_default = {
	avatars: "_avatars_1p9cu_1",
	avatar: "_avatar_1p9cu_1",
	hiddenBadge: "_hiddenBadge_1p9cu_10",
	userList: "_userList_1p9cu_23",
	groupContainer: "_groupContainer_1p9cu_30",
...
var TabBar_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_q7lw5_1",
	floating: "_floating_q7lw5_12"
};
...
var ActionsDropdownMenu_vue_vue_type_script_setup_true_lang_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props, { expose: __expose }) {
		...
		const { getDependencies, fetchDependencies, fetchDependencyCounts, hasDependencies } = useDependencies();
		const { buildDependencyMenuItems, resolveDependencyMenuId, openDependency } = useDependencyMenu();
		watch(() => props.id, (id) => {
			if (!id || props.isNewWorkflow) return;
			fetchDependencyCounts([id], "workflow");
		}, { immediate: true });
		const dependencyMenuChildren = computed(() => {
			const result = getDependencies(props.id, "workflow");
			const items = buildDependencyMenuItems(result?.dependencies ?? []);
			if (result && result.inaccessibleCount > 0) items.push({
		...
		function handleFileImport() {
			...
			if (inputRef?.files && inputRef.files.length !== 0) {
				...
				reader.onload = () => {
					...
					mcpJsonNudgeTrigger.gate("import_file", () => nodeViewEventBus.emit("importWorkflowData", { data: workflowData }));
				};
		...
		const workflowMenuItems = computed(() => {
			...
			if (!props.isNewWorkflow && hasDependencies(props.id, "workflow")) nameAndMetadata.push({
		...
		function onWorkflowMenuToggle(open) {
			if (!open || !props.id || props.isNewWorkflow) return;
			fetchDependencies([props.id], "workflow");
		}
		async function onWorkflowMenuSelect(action) {
			const dependency = resolveDependencyMenuId(getDependencies(props.id, "workflow")?.dependencies ?? [], action);
			if (dependency) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", { class: normalizeClass([unref($style).group]) }, [
				...
				createVNode(unref(DropdownMenu_default), {
					...
					"onUpdate:modelValue": onWorkflowMenuToggle
				}, {
...
var ActionsDropdownMenu_vue_vue_type_style_index_0_lang_module_default = {
	destructiveItem: "_destructiveItem_y4zit_1",
	group: "_group_y4zit_6",
	checklistAnchor: "_checklistAnchor_y4zit_10",
	hiddenInput: "_hiddenInput_y4zit_16"
};
...
var CollaborationPane_vue_vue_type_style_index_0_lang_module_default = { container: "_container_1r1q8_1" };
...
function useWorkflowPublicationStatusSync(documentId) {
	...
	async function refetch() {
		if (disposed || !settingsStore.isWorkflowPublicationServiceEnabled || workflowsStore.isNewWorkflow) return;
...
var WorkflowPublishChoiceDialog_vue_vue_type_style_index_0_lang_module_default = {
	description: "_description_qxiis_1",
	footer: "_footer_qxiis_6",
	actions: "_actions_qxiis_11",
	dontShowAgain: "_dontShowAgain_qxiis_16"
};
...
var WorkflowReviewSubmittedDialog_vue_vue_type_style_index_0_lang_module_default = {
	description: "_description_e4d4y_1",
	footer: "_footer_e4d4y_6",
	dontShowAgain: "_dontShowAgain_e4d4y_11"
};
...
var WorkflowUpdateReviewDialog_vue_vue_type_style_index_0_lang_module_default = {
	description: "_description_f2b2r_1",
	form: "_form_f2b2r_6",
	step: "_step_f2b2r_13"
};
...
var WorkflowReviewStatusBanner_vue_vue_type_style_index_0_lang_module_default = {
	pill: "_pill_1kwpb_3",
	info: "_info_1kwpb_19",
	warning: "_warning_1kwpb_27",
	popover: "_popover_1kwpb_35",
	content: "_content_1kwpb_39",
	actions: "_actions_1kwpb_45"
};
...
var WorkflowHeaderDraftPublishActions_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_tyebx_2",
	activeVersionIndicator: "_activeVersionIndicator_tyebx_6",
	icon: "_icon_tyebx_10",
	reviewStatusBannerSlot: "_reviewStatusBannerSlot_tyebx_20",
	publishButtonWrapper: "_publishButtonWrapper_tyebx_26",
	buttonGroup: "_buttonGroup_tyebx_31",
	groupButtonLeft: "_groupButtonLeft_tyebx_37",
	groupButtonRight: "_groupButtonRight_tyebx_49",
	indicatorDot: "_indicatorDot_tyebx_59",
	publishingSpinner: "_publishingSpinner_tyebx_67",
	indicatorPublished: "_indicatorPublished_tyebx_71",
	indicatorPublishedText: "_indicatorPublishedText_tyebx_75",
	indicatorChanges: "_indicatorChanges_tyebx_79",
	indicatorIssues: "_indicatorIssues_tyebx_83",
	indicatorPartial: "_indicatorPartial_tyebx_87",
	flex: "_flex_tyebx_91"
};
...
var container$1 = "_container_qey36_1";
var closeNodeViewDiscovery = "_closeNodeViewDiscovery_qey36_27";
var WorkflowDetails_vue_vue_type_style_index_1_lang_module_default = {
	container: container$1,
	"path-separator": "_path-separator_qey36_12",
	closeNodeViewDiscovery,
	"header-controls": "_header-controls_qey36_34"
};
var WorkflowDetails_default = /* @__PURE__ */ _plugin_vue_export_helper_default(WorkflowDetails_vue_vue_type_script_setup_true_lang_default, [["__cssModules", { "$style": WorkflowDetails_vue_vue_type_style_index_1_lang_module_default }], ["__scopeId", "data-v-29b3c96d"]]);
//#endregion
...
var MainHeader_vue_vue_type_style_index_0_lang_module_default = {
	container: "_container_sqfsw_1",
	"main-header": "_main-header_sqfsw_8",
	"canvas-only": "_canvas-only_sqfsw_16",
	"top-menu": "_top-menu_sqfsw_22"
};
