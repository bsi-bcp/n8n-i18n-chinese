const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/workers-CjMSUN_H.js","assets/comlink-Dj02YgWV.js"])))=>i.map(i=>d[i]);
...
import { i as i18n, n as addHeaders, r as addNodeTranslation, s as useI18n } from "./src-Bo6fIRlP.js";
import { t as __vitePreload } from "./preload-helper-CMc80dNB.js";
import { B as throttledWatch, P as createEventHook, x as useLocalStorage } from "./dist-CaaDNBsJ.js";
import { t as truncate } from "./truncate-B0m9bkui.js";
import { c as useRoute } from "./vue-router-BayijiqM.js";
import { s as require_memoize, t as require_get } from "./get-Bo7Q_OPC.js";
...
import { Ai as getActiveCredentialTypes, Br as createRunExecutionData, Cn as require_pick, Di as checkConditions, Fn as Workflow, Ha as CHAT_TRIGGER_NODE_TYPE, Ii as getNodeWebhookUrl, Lt as getResourcePermissions, Mi as getNodeInputs, Mn as normalizeNodeShape, Na as UnexpectedError, Ni as getNodeOutputs, Oa as sleep$1, Oi as displayParameter, Or as isTrimmedNodeExecutionData, Pi as getNodeParameters, Ui as isHitlToolType, Vn as require__baseIteratee, Xn as normalizeGroupDescription, Zi as nodeIssuesToString, _a as isExpression, _i as getChildNodes, ao as SEND_AND_WAIT_OPERATION, ar as require__baseFindIndex, ba as deepCopy, da as isResourceMapperValue$1, do as require_isEqual, ga as traverseNodeParameters, hi as mapConnectionsByDestination, ja as ExpressionError, ji as getConnectionTypes, ki as displayParameterPath, kn as isAssignmentCollectionValue, lo as v4, ma as nodeConnectionTypes, mi as resolveVariables, no as MANUAL_TRIGGER_NODE_TYPE, nr as require__baseUniq, pa as NodeConnectionTypes, po as require_keys, ra as isFilterValue, so as WAIT_INDEFINITELY, tr as splitExpression, ua as isResourceLocatorValue, zr as createEmptyRunExecutionData } from "./src-BvYowTlb.js";
import { b as require_isArrayLike, t as require_merge } from "./merge-CuvWsBtd.js";
...
import { $n as WORKFLOW_TRIGGER_NODE_TYPE, At as AI_TRANSFORM_NODE_TYPE, Bt as CREDENTIAL_ONLY_NODE_PREFIX, Ca as WorkflowIdKey, Cn as NON_ACTIVATABLE_TRIGGER_NODE_TYPES, H as AI_CATEGORY_AGENTS, Hr as MAIN_HEADER_TABS, I as CUSTOM_API_CALL_KEY, In as SCHEDULE_TRIGGER_NODE_TYPE, J as AI_CATEGORY_MCP_NODES, K as AI_CATEGORY_HUMAN_IN_THE_LOOP, L as DATA_TYPE_ICON_MAP, N as IN_PROGRESS_EXECUTION_ID, O as TEMPLATES_NODES_FILTER, P as PLACEHOLDER_FILLED_AT_EXECUTION_TIME, Qn as WIKIPEDIA_TOOL_NODE_TYPE, Sa as WorkflowDocumentStoreKey, X as AI_CATEGORY_OTHER_TOOLS, Xt as ERROR_TRIGGER_NODE_TYPE$1, Zn as WEBHOOK_NODE_TYPE$1, _n as MESSAGE_AN_AGENT_NODE_TYPE, an as HTTP_REQUEST_NODE_TYPE, dn as LIST_LIKE_NODE_OPERATIONS, fo as EnterpriseEditionFeature, i as DUPLICATE_POSTFFIX, kt as AI_MCP_TOOL_NODE_TYPE, lt as BETA_NODES, mt as HUMAN_IN_THE_LOOP_CATEGORY, nt as AI_CATEGORY_VECTOR_STORES, pa as CanvasRenderDataKey, pt as HITL_SUBCATEGORY, r as DEFAULT_SETTINGS, rn as FORM_TRIGGER_NODE_TYPE$1, rt as AI_CODE_TOOL_LANGCHAIN_NODE_TYPE, ut as CORE_NODES_CATEGORY, vt as RECOMMENDED_NODES, xn as NODE_POSITION_CONFLICT_ALLOWLIST, yn as MODULE_ENABLED_NODES, z as MAPPING_PARAMS, za as INLINE_AGENTS_EXPERIMENT } from "./constants-CfolRcla.js";
import { l as TIME } from "./durations-B_eUP1zI.js";
import { i as require_toNumber } from "./useDebounce-C57cDTa1.js";
import { t as usePostHog } from "./posthog.store-BzH8pehx.js";
import { c as isEmpty, d as isPresent, h as stringSizeInBytes, m as shorten, p as omit, u as isJsonKeyObject, v as getObjectSizeInKB, y as isObject$1 } from "./typesUtils-MNq3j-_F.js";
import { a as getNewWorkflow, i as getLastSuccessfulExecution, l as getWorkflows, n as useFavoritesStore, r as getExecutionData, t as useWorkflowsListStore } from "./workflowsList.store-btNOTGAu.js";
import { m as CANCELLABLE_EXECUTION_STATUSES, n as useUIStore } from "./ui.store-DF3DguxG.js";
import { c as hasRole, t as hasPermission } from "./permissions-DKa3WUtV.js";
import { o as require_startCase, t as useEvaluationStore } from "./evaluation.store-BQJfd372.js";
import { r as noCase } from "./dist-C7QIcMVA.js";
import { t as require_sortBy } from "./sortBy-D5wdwS2E.js";
...
* page.
*/
function useRemoteProjectSearch(options = {}) {
	...
	const loadNodesInformationFromLocalDb = async (nodeInfos) => {
		try {
			const { getNodeType } = await __vitePreload(async () => {
				const { getNodeType } = await import("./workers-CjMSUN_H.js");
				return { getNodeType };
			}, __vite__mapDeps([0,1]));
			const found = [];
			const missing = [];
	...
	const loadNodeTypesFromLocalDb = async () => {
		try {
			const { loadNodeTypes, getAllNodeTypes } = await __vitePreload(async () => {
				const { loadNodeTypes, getAllNodeTypes } = await import("./workers-CjMSUN_H.js");
				return {
					loadNodeTypes,
					getAllNodeTypes
				};
...
*/
function useExistingWorkflowDocumentStore(id) {
	const pinia = getActivePinia();
	if (!pinia || !(getWorkflowDocumentStoreId(id) in pinia.state.value)) return void 0;
...
//#endregion
export { groupItemsInSections as $, isCanvasGroupNode as $i, getNodeCredentialForSelectedAuthType as $n, NodeId as $r, resolveRequiredParameters as $t, useExistingWorkflowDocumentStore as A, isCredentialsResource as Ai, downloadDataTableCsvApi as An, resolveCanonicalConnection as Ar, generateCodeForPrompt as At, useEnvFeatureFlag as B, isTriggerPanelObject as Bi, uploadCsvFileApi as Bn, doRectsOverlap as Br, getMappedResult as Bt, createExecutionPreviewDocumentId as C, CHANGE_ACTION as Ci, moveFolderToProject as Cn, getMaxNodePortsLabelSize as Cr, useAiGatewayStore as Ct, disposeWorkflowDocumentStore as D, isBinaryLike as Di, deleteDataTableApi as Dn, mapLegacyConnectionToCanvasConnection as Dr, chatWithAssistant as Dt, deriveHomeProject as E, isBaseTextKey as Ei, createDataTableApi as En, mapCanvasConnectionToLegacyConnection as Er, useCredentialsStore as Et, doesNodeHaveCredentialsToFill as F, isResourceMapperValue as Fi, insertDataTableRowApi as Fn, DEFAULT_NODE_SIZE as Fr, useAIAssistantHelpers as Ft, extractAiGatewaySection as G, isWorkflowListItem as Gi, getAllNodeCredentialForAuthType as Gn, getMousePosition as Gr, getResolvableState as Gt, useNodeTypesStore as H, isValidNodeConnectionType as Hi, fieldCannotBeDeleted as Hn, getBounds as Hr, completeExpressionSyntax as Ht, getNodeTypeDisplayableCredentials as I, isResourceSortableByDate as Ii, moveDataTableColumnApi as In, DEFAULT_VIEWPORT_BOUNDARIES as Ir, useDataSchema as It, flattenCreateElements as J, CANVAS_NODE_GROUP_TYPE as Ji, getAuthTypeForNodeCredential as Jn, getNodesGroupSize as Jr, removeExpressionPrefix as Jt, filterAndSearchNodes as K, CANVAS_NODE_GROUP_HANDLE_LEFT as Ki, getAppNameFromCredType as Kn, getNewNodePosition as Kr, isPairedItemIntermediateNodesError as Kt, getParameterDisplayableOptions as L, isRouteLocationRaw as Li, renameDataTableColumnApi as Ln, HORIZONTAL_NODE_STEP as Lr, useFlattenSchema as Lt, TOOL_NODE_TYPES_NEED_INPUT as M, isDebouncedFunction as Mi, fetchDataTablesApi as Mn, injectStrict as Mr, getBuilderCredits as Mt, assignNodeId as N, isFullExecutionResponse as Ni, getDataTableRowsApi as Nn, CONFIGURABLE_NODE_SIZE as Nr, replaceCode as Nt, injectWorkflowDocumentStore as O, isComponentPublicInstance as Oi, deleteDataTableColumnApi as On, mapLegacyConnectionsToCanvasConnections as Or, chatWithBuilder as Ot, doesNodeHaveAllCredentialsFilled as P, isProjectRole as Pi, importCsvToDataTableApi as Pn, CONFIGURATION_NODE_SIZE as Pr, truncateBuilderMessages as Pt, getSendAndWaitNodes as Q, createCanvasGroupNodeId as Qi, getNodeAuthOptions as Qn, MarkerType as Qr, resolveParameter as Qt, needsAgentInput as R, isSharedResource as Ri, updateDataTableApi as Rn, PUSH_NODES_OFFSET as Rr, escapeMappingString as Rt, toolActivityKey as S, useExecutionDataStore as Si, ProjectTypes as Sn, createEmptyCanvasRenderData as Sr, stripToolSuffix as St, createWorkflowDocumentId as T, checkExhaustive as Ti, addDataTableColumnApi as Tn, insertSpacersBetweenEndpoints as Tr, listenForCredentialChanges as Tt, isDataWorkerEnabled as U, isVariableResource as Ui, filterTemplateNodes as Un, getGenericHints as Ur, getExpressionErrorMessage as Ut, require_uniq as V, isValidCredentialResponse as Vi, executionDataToJson as Vn, generateOffsets as Vr, propertyNameFromExpression as Vt, useActionsGenerator as W, isVueFlowConnection as Wi, getActivatableTriggerNodes as Wn, getMidCanvasPosition as Wr, getExternalSecretPreview as Wt, getHumanInTheLoopActions as X, CanvasNodeDirtiness as Xi, getMainAuthField as Xn, snapToGrid as Xr, stringifyExpressionResult as Xt, getAiTemplatesCallout as Y, CanvasConnectionMode as Yi, getInactiveCredentials as Yn, getNodesWithNormalizedPosition as Yr, shouldConvertToExpression as Yt, getRootSearchCallouts as Z, CanvasNodeRenderType as Zi, getNodeAuthFields as Zn, updateViewportToContainNodes as Zr, unwrapExpression as Zt, disposeWorkflowExecutionStateStore as _, getPinDataSize as _i, splitName as _n, applyOffset as _r, isTutorialTemplateId as _t, executionFilterToQueryFilter as a, _sfc_main$d as ai, ensureNodePosition as an, hasProxyAuth as ar, prepareCommunityNodeDetailsViewStack as at, skillIdActivityKey as b, disposeExecutionDataStore as bi, useProjectsStore as bn, createCanvasConnectionHandleString as br, getN8nAgentsNodeName as bt, getDefaultExecutionFilters as c, getBezierPath as ci, sortNodesByExecutionOrder as cn, isRequiredCredential as cr, shouldShowCommunityNodeDetails as ct, hasCancellableExecutions as d, getRectOfNodes as di, injectNDVStoreIfProvided as dn, isValueExpression as dr, subcategorizeItems as dt, parseCanvasGroupNodeId as ea, PanelPosition as ei, useWorkflowHelpers as en, getNodeSubtitle as er, isAINode as et, hasTrimmedRunData as f, getSmoothStepPath as fi, useNDVStore as fn, parseResourceMapperFieldName as fr, transformNodeType as ft, parse as g, wheelDelta as gi, getTruncatedProjectName as gn, isCredentialOnlyNodeType as gr, getTutorialTemplates as gt, waitingNodeTooltip as h, useVueFlow as hi, ResourceType as hn, probeCredential as hr, getSampleWorkflowByTemplateId as ht, displayForm as i, _sfc_main$3 as ii, useTagsStore as in, hasOnlyListMode as ir, nodeTypesToCreateElements as it, useWorkflowDocumentStore as j, isDateObject as ji, fetchDataTableGlobalLimitInBytes as jn, shouldIgnoreCanvasShortcut as jr, getAiSessions as jt, provideWorkflowDocumentStore as k, isCredentialModalState as ki, deleteDataTableRowsApi as kn, parseCanvasConnectionHandleString as kr, clearBuilderSession as kt, getExecutionErrorMessage as l, getBoundsofRects as li, disposeNDVStore as ln, isResourceMapperFieldListStale as lr, showsAiGatewaySection as lt, unflattenExecutionData as m, useGetPointerPosition as mi, useEnvironmentsStore as mn, getAllCredentials as mr, getRagStarterWorkflowJson as mt, buildExecutionResponseFromSchema as n, isBinary as na, _sfc_main as ni, useWorkflowId as nn, getTriggerNodeServiceName as nr, isNodePreviewKey as nt, executionRetryMessage as o, _sfc_main$f as oi, removeWorkflowExecutionData as on, isAuthRelatedParameter as or, removePreviewToken as ot, openFormPopupWindow as p, isMacOs as pi, LOCAL_STORAGE_NDV_PANEL_WIDTH as pn, updateNodeAuthType as pr, SampleTemplates as pt, finalizeItems as q, CANVAS_NODE_GROUP_HANDLE_RIGHT as qi, getAppNameFromNodeName as qn, getNodeViewTab as qr, isTestableExpression as qt, clearPopupWindowState as r, _sfc_main$1 as ri, useAnnotationTagsStore as rn, hasExpressionMapping as rr, mapToolSubcategoryIcon as rt, findTriggerNodeToAutoSelect as s, clamp as si, sanitizeConnections as sn, isMatchingField as sr, searchNodes as st, useWorkflowsStore as t, structuralComputed as ta, Position as ti, useRouteWorkflowId as tn, getThemedValue as tr, isAiGatewayEligibleNode as tt, getExecutionErrorToastConfiguration as u, getConnectedEdges as ui, injectNDVStore as un, isResourceMapperSchemaIncomplete as ur, sortNodeCreateElements as ut, injectWorkflowExecutionStateStore as v, pinDataToExecutionData as vi, useAvailableProjectSearch as vn, checkOverlap as vr, isFullTemplatesCollection as vt, createExecutionPreviewDocumentVersion as w, getPairedItemId as wi, setWorkflowSharedWith as wn, injectCanvasRenderData as wr, sublimeSearch as wt, skillNameActivityKey as x, hasExecutionDataStore as xi, useSourceControlStore as xn, createCanvasConnectionId as xr, useInlineAgentsExperiment as xt, useWorkflowExecutionStateStore as y, createExecutionDataId as yi, useRemoteProjectSearch as yn, computeNodeDisplaySize as yr, isTemplatesWorkflow as yt, serializeNode as z, isString as zi, updateDataTableRowsApi as zn, calculateNodeSize as zr, getMappedExpression as zt };
