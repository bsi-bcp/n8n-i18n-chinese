...
| 2.34 ~ 2.38.6 | `release/2.38.7`（首选）或上游 2.33.7 | 本仓库 / 上游 | 实测可用（2.38.4 / 2.38.7 后端实证）；用 2.33.7 旧包时 2.34+ 新增文案显示英文 |
| **2.38.7** | **`release/2.38.7`（精确匹配）** | 本仓库 Releases | 8341 条全量汉化，2.34+ 新增文案全部有中文 |
| > 2.38.7 | 就近低版本 dist 搭配 | 本仓库 Releases | 等本仓库跟进发版；期间新文案回退英文，功能不受影响 |
