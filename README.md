...
| **2.39.7** | **`release/2.39.7`（精确匹配）** | 本仓库 Releases / 镜像 | 8372 键全量汉化 + 术语质量大修（728 处：智能体/凭据/脱敏/套餐等统一，详见 CHANGELOG）；镜像 `registry.bcpcloud.cn/bcp/bcphub-n8n/n8n-chinese:2.39.7` |
