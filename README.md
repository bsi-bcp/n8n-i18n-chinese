...
| **2.39.0 ~ 2.39.6** | **`release/2.39.6`（精确匹配）** | 本仓库 Releases / 镜像 | 8372 条全量汉化，AI 助手新界面含中文；镜像 `registry.bcpcloud.cn/bcp/bcphub-n8n/n8n-chinese:2.39.6` |
| > 2.39.6 | 就近低版本 dist 搭配 | 本仓库 Releases | 等本仓库跟进发版；期间新文案回退英文，功能不受影响 |
