...
- node.js.yml dispatch 或人工触发 → 版本 semver 白名单校验 → checkout 对应 tag → **docker buildx multi-arch（amd64+arm64）** 构建推 `registry.bcpcloud.cn/bcp/bcphub-n8n/n8n-chinese:<ver>`；
